...
#ifndef _FAST_DDS_GENERATED_SENSORMSG_H_
#define _FAST_DDS_GENERATED_SENSORMSG_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(SensorMsg_SOURCE)
#define SensorMsg_DllAPI __declspec( dllexport )
#else
#define SensorMsg_DllAPI __declspec( dllimport )
#endif // SensorMsg_SOURCE
#else
#define SensorMsg_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define SensorMsg_DllAPI
#endif // _WIN32
...
/*!
 * @brief This class represents the structure SensorMsg defined by the user in the IDL file.
 * @ingroup SENSORMSG
 */
class SensorMsg
{
public:
     ...
     */
    eProsima_user_DllExport SensorMsg();
     ...
     * @param x Reference to the object SensorMsg that will be copied.
     */
    eProsima_user_DllExport SensorMsg(
            const SensorMsg& x);
     ...
     * @param x Reference to the object SensorMsg that will be copied.
     */
    eProsima_user_DllExport SensorMsg& operator =(
            const SensorMsg& x);
     ...
     * @param x SensorMsg object to compare.
     */
...
#endif // _FAST_DDS_GENERATED_SENSORMSG_H_